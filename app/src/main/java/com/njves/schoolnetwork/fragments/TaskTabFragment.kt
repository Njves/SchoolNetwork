...
class TaskTabFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        pager.adapter = TaskPagerAdapter(childFragmentManager, listOf(TaskFragment.newInstance(TaskFragment.FLAG_GET), TaskFragment.newInstance(TaskFragment.FLAG_GET_MY)))
